<div class="sidebar" id="sidebar">
    ...
    <a href="{{ route('technician.dashboard') }}" class="sidebar-header">
        <div class="logo">
            <img src="/images/logo/favicon.ico" alt="ทรายคำวัสดุ Logo" width="40" height="40" />
        </div>
        <span class="sidebar-title" style="margin-top: 5px;">ทรายคำวัสดุ  <p style="font-size: small; margin-top: 3px;">{{'ผู้ใช้งาน: '.Auth::user()->name.' '.Auth::user()->last_name ?? 'ช่าง' }}</p></span>
    </a>
    ...
    <ul class="nav-menu">
        <li class="nav-item">
            <a href="{{ route('technician.dashboard') }}" class="nav-link active">
                ...
                <span class="nav-text">ปฏิทิน</span>
    ...
    <div class="user-section">
        <div class="user-dropdown">
            ...
            <div class="dropdown-menu" id="userDropdown">
                <a href="{{ route('profile.show') }}" class="dropdown-item2">โปรไฟล์</a>
