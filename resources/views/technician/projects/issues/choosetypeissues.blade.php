...
@section('content')
    <div class="main-content">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            ...
            <a href="{{ route('technician.projects.index',$projects->id) }}" class="btn btn-primary">ย้อนกลับ</a>
        </div>
        ...
        <div class="box-selecttype">
            <a href="{{ route('technician.projects.issues.create',$projects->id) }}" class="a-selecttype" >1. ปัญหาวัสดุ</a>
        </div>
        <div class="box-selecttype">
            <a href="{{ route('technician.projects.generalissues',$projects->id) }}" class="a-selecttype">2. ปัญหาทั่วไป</a>
        </div>
    </div>
@endsection