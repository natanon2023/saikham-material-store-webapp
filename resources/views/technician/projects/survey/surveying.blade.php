            ...
            <tr>
                ...
                <td>
                    <div style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                        <a href="{{ route('technician.projects.formeditprojectimage',$image->id) }}" class="btn-icon btn-edit" title="แก้ไข">
        ...
        <div>
            <table>
                ...
                <tr style="text-align: center;">
                    ...
                    <td>
                        <div style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                            <a href="{{ route('technician.projects.editformcustomerneed',$customerneed->id) }}" class="btn-icon btn-edit" title="แก้ไข">
                                <i class="fas fa-edit "></i>
                            </a>
