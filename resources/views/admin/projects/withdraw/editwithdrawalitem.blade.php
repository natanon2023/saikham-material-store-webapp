...
<div class="main-content">
    ...
    <div class="boxmaterial" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <a href="{{ route('admin.projects.withdrawdetails', $item->withdrawal->project_id) }}" class="btn btn-primary">ย้อนกลับ</a>
    </div>
    ...
    <div class="boxmaterial">
        ...
        <form action="{{ route('admin.projects.edit_withdrawal_item', $item->id) }}" method="POST"
