...
<div class="main-content">
    <div class="boxmaterial hide-on-print" style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="{{ route('customer.projectdetail', $project->id) }}" class="btn btn-primary">ย้อนกลับ</a>
            <a href="{{ route('customer.pdf.taxinvoice', $project->id) }}"
            target="_blank"
            class="btn" style="background:#17a2b8; color:white;">
